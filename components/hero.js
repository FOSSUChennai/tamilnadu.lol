    ...
    <section className="relative mt-16 md:mt-0 mx-auto grid min-h-[70vh] w-full max-w-6xl grid-cols-1 items-center gap-8 px-4 py-8 md:min-h-[80vh] md:grid-cols-2 md:px-8 lg:px-16">
      <div className="order-1 md:order-1">
        ...
        <div className="mt-8 flex items-center gap-4">
          <a href="https://github.com/FOSSUChennai/tamilnadu.lol" target="_blank" rel="noopener noreferrer" className="rounded-full border border-[#32cd32] px-3 py-1  md:px-6 md:py-3 text-[#1f7a1f] transition hover:bg-[#eaffea]">
            Contribute
          </a>
        </div>
      </div>
      ...
      <div className="order-2 flex items-center justify-center md:order-2">
        <div className="relative scale-180 h-96 w-96 md:h-96 md:w-96">
